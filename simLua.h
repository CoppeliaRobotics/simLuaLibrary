...
LUALIB_DLLEXPORT void luaLib_lua_pushcfunction(luaWrap_lua_State* L,luaWrap_lua_CFunction func);
LUALIB_DLLEXPORT void luaLib_lua_createtable(luaWrap_lua_State* L,int narr, int nrec);
